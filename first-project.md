...
- **Production** : remplace `new InMemoryFactStore()` par l'adaptateur Postgres (injecté), appelle
  `initLibxnSchema()` au démarrage, scope par client/organisation — voir [Persistance](/persistence).
